...
namespace Okra
{
    public partial class FrmProduct : Form
    {
        ...
        {
            SqlCommand sqlCommand = new SqlCommand("Insert into Products(Name,Code) values (@p1, @p2)", context.Connection());
        ...
        {
            SqlCommand sqlCommand = new SqlCommand("Delete From Products where Id=@p1", context.Connection());
        ...
        {
            SqlCommand sqlCommand = new SqlCommand("Update Products set Name=@p1, Code=@p2 where Id=@p3", context.Connection());
            sqlCommand.Parameters.AddWithValue("@p1", txtName.Text);
            sqlCommand.Parameters.AddWithValue("@p2", txtCode.Text);
